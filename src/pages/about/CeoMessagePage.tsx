...
천장형 원적외선 복사난방패널의 자체 개발부터 매립형·노출형·방폭형·스마트 제어 라인업까지, 한 분야의 깊이를 만드는 데 자원을 투자해왔습니다. 학교, 군 시설, 물류센터, 공공시설 등 다양한 현장에서 바람 없이 체감되는 난방 환경을 검증해왔습니다.`,
  ...
  },
  {
    ...
    body: `2013년·2019년·2025년 세 번에 걸친 조달청 우수제품 지정, 혁신시제품 선정, K마크 6종 성능인증, 방폭(Ex e mb Ⅱ T1) 인증, 유럽 CE·RoHS 인증은 내부의 자랑이 아니라 매년 다시 받아야 하는 외부 검증입니다. 공공기관 담당자가 우리 제품을 의심 없이 도면에 올릴 수 있도록 인증·시방·일위대가 자료를 정비된 형태로 제공하는 것을 회사의 의무라고 생각합니다.`,
  },
  {
    title: '앞으로의 약속',
