...
const TIMELINE: Array<{
...
}> = [
  {
    ...
    body: '복사난방 분야 단독으로 세 번째 우수제품 지정. 공공기관 수의계약 자격을 2028년까지 유지합니다.',
    tone: 'red',
  },
  {
    year: '2020',
  ...
  },
  {
    ...
    body: '원적외선 복사난방 분야 최초 우수제품 지정. 공공조달 진입의 발판이 되었습니다.',
    tone: 'red',
  },
  {
    year: '1994',
    category: '창립',
    title: '(주)썬레이텍 설립',
    body: '원적외선 복사난방 기술 연구·개발 전문기업으로 출발. 매립·노출형 라인업의 토대를 마련했습니다.',
    tone: 'gray',
  },
];
