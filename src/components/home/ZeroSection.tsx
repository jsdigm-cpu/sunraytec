...
const ZERO_ITEMS = [
  {
    Icon: IconDust,
    title: '미세먼지 Zero',
    desc: '공기를 이동시키지 않아 분진·미세먼지가 발생하지 않습니다. 식품공장·의약품 창고·클린룸처럼 무풍·무분진 환경이 필수인 공간에서 대류난방은 사용 자체가 불가합니다.',
    hoverBg: 'rgba(200,57,43,0.15)',
  },
  {
    Icon: IconEMF,
    title: '전자파 Zero',
    desc: '원적외선은 자연광과 동일한 복사열입니다. 전자파 민감 장비가 밀집된 군 시설·정밀 계측 환경에서도 간섭 없이 안전하게 운용됩니다.',
    hoverBg: 'rgba(26,58,107,0.25)',
  },
  {
    Icon: IconFire,
    title: '화재위험 Zero',
    desc: '표면 온도가 낮고 개방형 화염이 없습니다. 방폭 인증(EX emb II T1) 취득으로 탄약고·도장공장·화학창고 등 위험물 취급 현장에 유일하게 설치 가능한 난방입니다.',
    hoverBg: 'rgba(230,126,34,0.18)',
  },
  {
    Icon: IconDew,
    title: '결로 Zero',
    desc: '복사열이 벽·바닥 표면을 직접 가열해 표면 온도를 이슬점 이상으로 유지합니다. 항만 창고·냉동 물류 인접 공간·지하 시설에서 결로를 근본적으로 차단합니다.',
    ...
    <section style={{ background: 'var(--navy)', padding: '72px 0' }}>
      <div className="container">
        ...
        <ScrollReveal variants={fadeInUp} style={{ textAlign: 'center', marginBottom: '48px' }}>
          ...
          >
            4대 <span style={{ color: 'var(--red-light)' }}>ZERO</span> 캠페인
          </h2>
          <p style={{ color: 'rgba(255,255,255,.55)', marginTop: '10px', fontSize: '0.9rem' }}>
            썬레이텍 원적외선 복사난방이 실현하는 네 가지 약속
          </p>
        </ScrollReveal>
