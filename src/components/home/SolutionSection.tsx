...
const SOLUTIONS = [
  {
    icon: '🏛️',
    title: '공공·교육 시설',
    desc: '학교 급식실·체육관, 관공서, 복지관. 바람 없는 복사열로 호흡기 질환 예방. 조달청 3자단가 계약으로 수의계약 없이 간편 구매.',
  ...
  },
  {
    icon: '⚔️',
    title: '국방·특수 시설',
    desc: '탄약고·화약 취급 시설. 방폭 인증(EX emb II T1) 제품으로 가연성 환경에서도 합법적으로 설치 가능한 유일한 전기 난방입니다.',
    tags: ['방폭 EX 인증', 'IP-65', '탄약고 적용'],
    color: 'var(--red)',
  },
  {
    icon: '🚌',
