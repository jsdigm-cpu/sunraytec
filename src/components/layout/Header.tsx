...
const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    subs: [
      ...
      { to: '/solutions/iot-control', label: 'IoT 중앙제어', icon: '📡' },
    ],
  },
  {
    to: '/cases',
    ...
    subs: [
      ...
      { to: '/cases?category=education', label: '공공·교육 사례', icon: '🏛️' },
      { to: '/cases?category=industrial', label: '산업·물류 사례', icon: '🏭' },
      { to: '/cases?category=defense', label: '국방·특수 사례', icon: '⚔️' },
      { to: '/cases?category=commercial', label: '상업·라이프스타일', icon: '🏢' },
